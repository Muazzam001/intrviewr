$(document).ready(function () {
    var showVar = '';
    $(".section").bind('mousewheel DOMMouseScroll', _.debounce(function (event) {
...
//    $(".showcase").fadeOut(500).delay(1000).fadeIn(500);
    ...
    $("#bar4").click(function () {
        ...
        $("#section3 .devices img").removeClass("slideInLeft");
        $(".section").addClass("up");
        $("#section4").removeClass("on").removeClass("up").addClass("on").find(".content").addClass("animated slideInUp wait");
        showVar = "active4"
        $(".showcase").addClass(showVar)
    })
